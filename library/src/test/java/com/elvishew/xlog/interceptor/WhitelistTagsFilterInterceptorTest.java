...
public class WhitelistTagsFilterInterceptorTest {

  private WhitelistTagsFilterInterceptor interceptor;

  @Before
  public void setup() {
    interceptor = new WhitelistTagsFilterInterceptor("abc", "def");
  }
